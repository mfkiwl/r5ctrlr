...
print('      <H2>Phase Lead-Lag IIR coefficients calculation utility</H2>')
print('      </td>')
print('    </tr>')
print('  </table>')
print('</head>')
...
for name in arguments.keys():
  ...
  if name=='fz':
    fz=float(arguments[name][0])
  elif name=='fp':
    fp=float(arguments[name][0])
  elif name=='ch':
...
if( calccoeff and queryok ):
  ...
  wp=2.*np.pi*fp
  # prewarp
  wz=2.*fsampl*np.tan(wz/(2.*fsampl))
  wp=2.*fsampl*np.tan(wp/(2.*fsampl))
...
print('General form of phase lead-lag transfer function:<br><br>')
print('<img width="151" height="80" src="/leadlag_formula.png" alt="Phase lead-lag formula in frequency domain">')
print('<br><br>')
print('It can be a lead or a lag depending on whether the zero comes before or after the pole:')
print('<br><br>')
print('<img width="560" height="420" src="/phlead.png" alt="Typical phase lead Bode diagram">')
print('<img width="560" height="420" src="/phlag.png" alt="Typical phase lag Bode diagram">')
print('<br>')
...
#-------  fz  -----------------------------
print('    <tr>')
print('      <td>Frequency of zero (f<sub>z</sub> = &omega;<sub>z</sub>/2&pi;) =</td>')
print('      <td>')
print(f'          <input type="number" name="fz" id="fz" value="{fz}" min="1" max="{fsampl/2.}" step="any"> Hz')
print('      </td>')
print('    </tr>')

#-------  fp  -----------------------------
print('    <tr>')
print('      <td>Frequency of pole (f<sub>p</sub> = &omega;<sub>p</sub>/2&pi;) =</td>')
print('      <td>')
print(f'          <input type="number" name="fp" id="fp" value="{fp}" min="1" max="{fsampl/2.}" step="any"> Hz')
print('      </td>')
print('    </tr>')
